                            ...
                            @foreach (config('app.languages') as $locale => $lang)
                                <div id="{{ $locale }}" class="tab-pane {{ $lang == 'English' ? 'active' : '' }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" required type="text" name="{{ $locale }}[title]" >
                                        @error($locale . '.title')
                                            ...
                                            <div class="col-12">
                                                <div class="card m-b-30">
                                                    <div class="card-body">
                                                            ...
                                                            <textarea id="elm1"  name="{{ $locale }}[your_tasks]"  ></textarea>
                                            ...
                                            <div class="col-12">
                                                <div class="card m-b-30">
                                                    <div class="card-body">
                                                            ...
                                                            <textarea id="elm1"  name="{{ $locale }}[carrer]"   ></textarea>
