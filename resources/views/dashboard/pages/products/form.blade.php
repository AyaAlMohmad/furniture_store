    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <form id="myForm" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="widget-main">
                        ...
                        <div class="tab-content padding-4">
                            ...
                            @foreach (config('app.languages') as $locale => $lang)
                                <div id="{{ $locale }}" class="tab-pane {{ $lang == 'English' ? 'active' : '' }}">
                                    ...
                                    <div class="form-group">
                                        <label for="{{ $locale }}[material]">
                                            {{ __('dashboard.material', [], $locale) }}
                                        </label>

                                        <input class="form-control"  type="text"
                                            placeholder="{{ $locale }}" name="{{ $locale }}[material]">
                                        @error($locale . '.material')
                                            <div style="color: red">{{ $message }}</div>
                                        @enderror
                                                ...
                                                <div class="col-12">
                                                    <div class="card m-b-30">
                                                        <div class="card-body">
                                                                ...
                                                                <textarea id="elm1"   placeholder="{{ $locale }}" name="{{ $locale }}[description]" ></textarea>
                        ...
                        <div class="card-body">
                            ...
                            <div class="m-b-30">
                                    ...
                                    <div class="fallback">
                                        <input name="image_main" type="file" multiple="multiple">
